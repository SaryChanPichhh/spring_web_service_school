...
public class FreeDeliveryAssignmentController {
    ...
    public ResponseEntity<FreeDeliveryAssignmentPageResponseDto<FreeDeliveryAssignmentResponse>> getPaginated(org.springframework.data.domain.Pageable pageable) {
